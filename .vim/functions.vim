...
" With simplification on all of the numbering, gutters and other stuff
" is hidden, making it easier to copy from that window (if for some
" reason like being logged in remotely you can't just yank);
